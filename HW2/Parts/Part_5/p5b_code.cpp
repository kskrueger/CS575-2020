...
int main() {
    Mat input = imread("/Users/kskrueger/CLionProjects/CV/src/cs575/HW2-2020/input/Part_5/p5_board_3b_grain.jpg");
    imshow("Input", input);
    ...
    erode(input_binary, input_binary, getStructuringElement(MORPH_RECT, Size(3, 3)));
    dilate(input_binary, input_binary, getStructuringElement(MORPH_RECT, Size(3, 3)));
